...
@login_required
def index(request):
    return render(request, 'participant_app/index.html')
...
def add_language(request):
    if request.method == "POST":
        ...
        form = LanguageForm()
    return render(request, "participant_app/Language/new.html", {'form': form})
...
def add_musical_skill(request):
    ...
    return render(request, "participant_app/MusicalSkill/new.html", {'form': form})
...
def adult_query(request):
    ...
    return render(request, 'participant_app/Adult/list.html', {'adultFilter': adultFilter, 'speaksFilter': speaksFilter, 'musicalExperienceFilter': musicalExperienceFilter, 'assessmentRunFilter': assessmentRunFilter, 'experimentSectionRunFilter': experimentSectionRunFilter, 'combined': combined})
...
def add_adult(request):
    ...
    return render(request, "participant_app/Adult/new.html", {'adult_form': adult_form, 'speaks_formset': speaks_forms, 'musical_experience_formset': musical_experience_forms, 'addParentForm': add_parent_form})
...
def update_adult(request, adult_id):
    ...
    return render(request, "participant_app/Adult/update.html", {'adult_id': adult_id, 'adult_form': adult_form, 'speaks_formset': speaks_forms, 'musical_experience_formset': musical_experience_forms})
...
def adult_detail(request, adult_id):
    ...
    try:
        ...
        return render(request, 'participant_app/Adult/view.html', {'adult': adult, 'speaksLanguages': speaks, 'musical_exps': musical_exps, 'families': families, 'all_parents': all_parents, 'all_children': all_children, 'assessment_participations': assessment_participations, 'all_scores': all_scores, 'eligible_assessments': eligible_assessments, 'experiment_section_participations': experiment_participations, 'eligible_experiment_sections': eligible_experiment_sections, 'all_experiment_scores': all_experiment_scores})
    except IsParentIn.DoesNotExist:
        return render(request, 'participant_app/Adult/view.html', {'adult': adult, 'speaksLanguages': speaks, 'musical_exps': musical_exps, 'assessment_participations': assessment_participations, 'all_scores': all_scores, 'eligible_assessments': eligible_assessments, 'experiment_section_participations': experiment_participations, 'eligible_experiment_sections': eligible_experiment_sections, 'all_experiment_scores': all_experiment_scores})
...
def child_query(request):
    ...
    return render(request, 'participant_app/Child/list.html', {'childFilter': childFilter,'exposureFilter': exposureFilter, 'assessmentRunFilter': assessmentRunFilter, 'experimentSectionRunFilter': experimentSectionRunFilter, 'combined': combined})
...
def add_child(request):
    ...
    return render(request, "participant_app/Child/new.html", {'child_form': child_form, 'exposure_forms': exposure_forms, 'addChildForm': add_child_form})
...
def update_child(request, child_id):
    ...
    return render(request, "participant_app/Child/update.html", {'child_id': child_id, 'child_form': child_form, 'exposure_forms': exposure_forms})
...
def child_detail(request, child_id):
    ...
    try:
        ...
        return render(request, 'participant_app/Child/view.html', {'child': child, 'languages_exposed_to': languages_exposed_to, 'family': family, 'parents': all_parents, 'siblings': all_children, 'assessment_participations': assessment_participations, 'all_scores': all_scores, 'eligible_assessments': eligible_assessments, 'experiment_section_participations': experiment_participations, 'eligible_experiment_sections': eligible_experiment_sections, 'all_experiment_scores': all_experiment_scores})
    except IsChildIn.DoesNotExist:
        messages.warning(request, 'Family not in database')
        return render(request, 'participant_app/Child/view.html', {'child': child, 'languages_exposed_to': languages_exposed_to, 'assessment_participations': assessment_participations, 'all_scores': all_scores, 'eligible_assessments': eligible_assessments, 'experiment_section_participations': experiment_participations, 'eligible_experiment_sections': eligible_experiment_sections, 'all_experiment_scores': all_experiment_scores})
...
def family_query(request):
    ...
    return render(request, 'participant_app/Family/list.html', {'familyFilter': familyFilter})
@login_required
def add_family(request):
    ...
    return render(request, "participant_app/Family/new.html", {'family_form': family_form, 'child_forms': child_forms, 'parent_forms': parent_forms})
...
def update_family(request, family_id):
    ...
    return render(request, "participant_app/Family/update.html", {'family_id': family_id, 'family_form': family_form, 'child_forms': child_forms, 'parent_forms': parent_forms})
...
def family_detail(request, family_id):
    ...
    return render(request, 'participant_app/Family/view.html', {'family': family, 'parents': parents, 'children': children, 'parentsSpeak': parentsSpeak, 'parentsMusic': parentsMusic, 'childrenLangExposure': childrenLangExposure})
...
def assessment_list(request):
    ...
    return render(request, 'participant_app/Assessment/list.html', {'assessments': eligible_assessments, 'assessment_run_counts': all_counts, 'assessment_fields': all_fields})
...
def add_assessment(request):
    ...
    return render(request, "participant_app/Assessment/new.html", {'assessment_form': assessment_form, 'assessment_field_formset': assessment_field_forms})
...
def update_assessment(request, assessment_name):
    ...
    if request.method == "POST":
        ...
        assessment_form.fields["lab"].queryset = Lab.objects.filter(group__name__in=get_user_groups(request))
    return render(request, "participant_app/Assessment/update.html", {'assessment_name': assessment_name,'assessment_form': assessment_form, 'assessment_field_formset': assessment_field_forms, 'canAccess': canAccess})
...
def assessment_detail(request, assessment_name):
    ...
    return render(request, 'participant_app/Assessment/view.html', {'canAccess': canAccess, 'assessment': assessment, 'assessment_fields': assessment_fields, 'assessment_runs': assessment_runs, 'all_scores': all_scores})
...
def choose_assessment(request):
    ...
    return render(request, 'participant_app/AssessmentRun/new1.html', {'assessments': assessments})
...
def add_assessment_run(request, assessment_name, participant_type, participant=None):
    ...
    return render(request, "participant_app/AssessmentRun/new2.html", {'assessment_name': assessment_name, 'field_score_pairs': field_score_pairs ,'assessment_run_form': assessment_run_form, 'assessment_run_field_score_formset': assessment_run_field_score_forms, 'participant_type': participant_type})
...
def assessment_run_detail(request, assessment_run_id):
    ...
    return render(request, 'participant_app/AssessmentRun/view.html', {'assessment_run': assessment_run, 'assessment_run_fields': assessment_run_fields})
...
def experiment_list(request):
    ...
    return render(request, 'participant_app/Experiment/list.html', {'experiments': eligible_experiments, 'experiment_run_counts': all_counts, 'experiment_sections': all_experiment_sections})
...
def add_experiment(request):
    ...
    return render(request, "participant_app/Experiment/new.html", {'experiment_form': experiment_form, 'experiment_section_formset': experiment_section_forms})
...
def update_experiment(request, experiment_name):
    ...
    if request.method == "POST":
        ...
        experiment_form.fields["lab"].queryset = Lab.objects.filter(group__name__in=get_user_groups(request))
    return render(request, "participant_app/Experiment/update.html", {'experiment_form': experiment_form, 'experiment_section_formset': experiment_section_forms, 'experiment_name': experiment_name, 'canAccess': canAccess})
...
def experiment_detail(request, experiment_name):
    ...
    return render(request, 'participant_app/Experiment/view.html', {'canAccess': canAccess, 'experiment': experiment, 'experiment_sections': experiment_sections, 'all_fields': all_fields})
...
def experiment_section_detail(request, experiment_name, experiment_section_name):
    ...
    canAccess = experiment.lab.group.name in authed_groups
    return render(request, 'participant_app/ExperimentSection/view.html', {'canAccess': canAccess, 'experiment': experiment, 'experiment_section': experiment_section, 'experiment_section_fields': experiment_section_fields, 'experiment_section_runs':experiment_section_runs, 'all_scores': all_scores})
...
def add_experiment_section_fields(request, experiment_name):
    ...
    return render(request, "participant_app/ExperimentSection/new.html", {'experiment': experiment, 'experiment_sections': experiment_sections, 'fields': fields})
...
def update_experiment_section_fields(request, experiment_name): 
    ...
    return render(request, "participant_app/ExperimentSection/update.html", {'experiment': experiment_inst, 'experiment_sections': experiment_sections, 'fields': fields})
...
def choose_experiment_section(request):
    ...
    return render(request, 'participant_app/ExperimentSectionRun/new1.html', {'experiment_sections': experiment_sections})
...
def add_experiment_section_run(request, experiment_section_name, experiment_name, participant_type, participant=None):
    ...
    return render(request, "participant_app/ExperimentSectionRun/new2.html", {'experiment_section_name': experiment_section_name,'experiment_name': experiment_name, 'field_score_pairs': field_score_pairs ,'experiment_section_run_form': experiment_section_run_form, 'experiment_section_run_field_score_formset': experiment_section_run_field_score_forms, 'participant_type': participant_type})
...
def experiment_section_run_detail(request, experiment_section_run_id):
    ...
    return render(request, 'participant_app/ExperimentSectionRun/view.html', {'experiment_section_run': experiment_section_run, 'experiment_section_run_fields': experiment_section_run_fields})
